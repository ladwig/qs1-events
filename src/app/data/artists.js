export const artists = [
  ...
  },
  {
    ...
    hide: false,
    hideRequestButton: false,
    description: "Beryll is a Berlin-based creative who brings an infectious energy to every set - Her passion for dancing also mirrors in her sets. Born and raised in NRW her sound weaves together the deep, dubby, and hypnotic elements of Techno and House.\n\nWith an instinct for rhythm and a passion for creating tension and release, her sets move effortlessly between driving grooves and subtle, trippy textures. Inspired by the transformative nature of the Chrysoberyl gemstone, her artist name reflects her approach to music—shaping emotions, energies, and moments on the dancefloor.\n\nThrough carefully curated selections and fluid transitions, Beryll builds a journey that goes into mind and body. Having played at clubs like Sisyphos, Else, Golden Gate, and beyond, she continues to carve her own path, bringing an intuitive and captivating energy to every set.",
    imageUrl: '/artists/beryll/beryll-1.webp',
    pressPackUrl: '/press/beryll-press-kit.zip',
    socialLinks: {
      instagram: 'https://www.instagram.com/beryll_berlin/',
      soundcloud: 'https://soundcloud.com/beryllberlin',
      residentAdvisor: 'https://de.ra.co/dj/beryll'
    },
  },
]; 