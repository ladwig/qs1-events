      ...
      >
        ...
        <div className="px-4 sm:px-8 pb-8">
          <p className="text-gray-800 leading-relaxed text-sm sm:text-base">
            Most of the merch is sold out. There are still a few pieces left — colored shirts and hoodies — available for pickup at QS1 Weißensee. Just ask.
          </p>
        </div>
      </div>
    </div>
...
// Legacy merch modal (kept commented for reference):
// 'use client';
//
